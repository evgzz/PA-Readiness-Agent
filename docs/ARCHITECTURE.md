...
The [swappable judge adapters](LLM_JUDGE.md) belong to the independent evaluation
plane: HF dedicated endpoints, supported closed APIs, optional HF routing and Jev.
